    ...
    <main class="profile-main">
        <section class="profile-intro">
            ...
            <?php if ($role === 'administrador'): ?>
                <a class="profile-admin-link" href="../admin/index.php">Ir al panel administrativo</a>
            <?php endif; ?>
        </section>
        ...
        <div class="profile-grid">
            ...
            <section class="profile-card">
                ...
                <form class="profile-form" action="profile.php" method="post" novalidate>
            ...
            <section class="profile-card profile-card--danger">
                ...
                <form class="profile-delete" action="profile.php" method="post">
