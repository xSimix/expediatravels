                    ...
                    >
                        ...
                        <div class="reservation-form__fields">
                            ...
                            <fieldset class="reservation-form__travellers">
                                ...
                                <p>Indica cuántas personas te acompañarán en el viaje.</p>
                                <div class="reservation-form__counter-grid">
                                    <label class="reservation-counter" data-counter>
                                    ...
                                    <label class="reservation-counter" data-counter>
                                        <span class="reservation-counter__label">Personas mayores</span>
                                        <div class="reservation-counter__controls">
                                            <button
                                                type="button"
                                                class="reservation-counter__btn"
                                                data-counter-decrease
                                                aria-label="Reducir personas mayores"
                                            >
                                                &minus;
                                            </button>
                                            <input
                                            ...
                                            <button
                                                ...
                                                class="reservation-counter__btn"
                                                data-counter-increase
                                                aria-label="Aumentar personas mayores"
                                            >
                                                +
                                            </button>
                                        </div>
                            ...
                            <div class="reservation-form__more" data-more-container>
                                <label class="reservation-more-toggle" for="reservation-more-options">
                                    <input
                                        id="reservation-more-options"
                                        type="checkbox"
                                        class="reservation-more-toggle__input"
                                        data-more-toggle
                                        aria-controls="reservation-more-content"
                                    />
                                    <span class="reservation-more-toggle__control">
                                        <span class="reservation-more-toggle__icon" data-more-icon aria-hidden="true">+</span>
                                        <span class="reservation-more-toggle__label">Más opciones</span>
                                    </span>
                                    <span class="reservation-more-toggle__hint">Comparte detalles especiales de tu reserva</span>
                                </label>
                                <div
                                    class="reservation-more-fields"
                                    id="reservation-more-content"
                                    data-more-content
                                    hidden
                                >
                                    <div class="reservation-more-grid">
                                        <label class="reservation-field">
                                            ...
                                            <input
                                                ...
                                                placeholder="Especifica apoyos o adaptaciones necesarias"
                                            />
                                        </label>
                                        <label class="reservation-field">
                                            ...
                                            <input
                                                ...
                                                type="text"
                                                name="pet_details"
                                                placeholder="Indica si viajarás con mascotas"
                                            />
                                        </label>
                                        <label class="reservation-field reservation-field--full">
                                            ...
                                            <input
                                                ...
                                                placeholder="Cuéntanos sobre alguna condición médica que debamos considerar"
                                            />
                                        </label>
                                        <label class="reservation-field reservation-field--full">
                                            <span class="reservation-field__label">Mensaje adicional</span>
                                            <textarea
                                                class="reservation-field__input reservation-field__input--textarea"
                                                name="message"
                                                placeholder="Comparte preferencias, restricciones o comentarios relevantes"
                                            ></textarea>
                                        </label>
                                    </div>
                                </div>
