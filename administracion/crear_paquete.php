    ...
    <section class="admin-card">
        <form method="post" class="admin-grid">
            ...
            <div class="admin-field">
                ...
                <input type="text" id="imagen_destacada" name="imagen_destacada" value="<?= htmlspecialchars($datos['imagen_destacada'], ENT_QUOTES, 'UTF-8'); ?>" placeholder="/web/imagenes/paquetes/oxapampa.jpg" />
